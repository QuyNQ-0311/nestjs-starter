...
-- CreateTable
CREATE TABLE "auth_service_user_roles" (
    "user_id" INTEGER NOT NULL,
    "role_id" INTEGER NOT NULL,

    CONSTRAINT "auth_service_user_roles_pkey" PRIMARY KEY ("user_id","role_id")
);

-- CreateTable
CREATE TABLE "auth_service_role_permissions" (
    "role_id" INTEGER NOT NULL,
    "permission_id" INTEGER NOT NULL,

    CONSTRAINT "auth_service_role_permissions_pkey" PRIMARY KEY ("role_id","permission_id")
);
...
-- CreateIndex
CREATE INDEX "auth_service_user_roles_role_id_idx" ON "auth_service_user_roles"("role_id");

-- CreateIndex
CREATE INDEX "auth_service_role_permissions_permission_id_idx" ON "auth_service_role_permissions"("permission_id");
...
-- AddForeignKey
ALTER TABLE "auth_service_user_roles" ADD CONSTRAINT "auth_service_user_roles_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth_service_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "auth_service_user_roles" ADD CONSTRAINT "auth_service_user_roles_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "auth_service_roles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "auth_service_role_permissions" ADD CONSTRAINT "auth_service_role_permissions_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "auth_service_roles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "auth_service_role_permissions" ADD CONSTRAINT "auth_service_role_permissions_permission_id_fkey" FOREIGN KEY ("permission_id") REFERENCES "auth_service_permissions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
